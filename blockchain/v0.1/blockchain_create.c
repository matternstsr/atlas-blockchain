...
blockchain_t *blockchain_create(void)
{
	...
	/* Assuming you have a linked list structure for chain
	...
	memset(genesis_block->prev_hash, 0, sizeof(genesis_block->prev_hash));
	strncpy((char *)genesis_block->data.buffer, "Holberton School", sizeof(genesis_block->data.buffer));
	...
	/* Assuming a linked list add function */
	return (blockchain);
}
